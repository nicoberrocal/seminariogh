...
<body>
	...
	<section id="container">
		...
		<h1><i class="fas fa-address-card"></i> Lista de proveedores</h1>
		<a href="registro_proveedor.php" class="btn_new"><i class="fas fa-address-book"></i> Crear proveedor</a>
		...
		<div class="paginador">
			...
			<?php 
			 ...
			 ?>
				...
				<li><a href="?pagina=<?php echo $pagina-1; ?>&busqueda=<?php echo $busqueda; ?>"><i class="fas fa-caret-left fa-lg"></i></a></li>
			<?php 
				}
